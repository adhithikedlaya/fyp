...
y_train_tensor = torch.complex(torch.from_numpy(csds[0].real), torch.from_numpy(csds[0].imag)).to(device) # this comes from csd var..  
...
# print(complex_mse_loss(yhat, y_train_tensor))
plot(yhat)